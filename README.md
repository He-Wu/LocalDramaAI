...
The verified PHASE 8 MP4 is `artifacts/phase8/20260812-203657-29f959d5/output/musetalk-b9a88f6a1b1a4428965b79a737da58b3.mp4`. It is a 640x368, 25 FPS H.264/yuv420p + AAC derivative of the immutable PHASE 7 video and Dialogue WAV. The SQLite link graph, provider manifest, review frames, resource samples, exact runtime, model revisions, byte sizes, and SHA256 hashes are locked in `runtime/runtime-lock.yaml`, `models/models.yaml`, and the Phase 8 evidence JSON.
